...
!function (a, b) {
    a.MixItUp = function () {
            ...
            for (var e = 0; e < d._$targets.length; e++) {
                ...
                if (f.dataset === b || c) {
                    ...
                    for (var g = 0; g < f.attributes.length; g++) {
                        var h = f.attributes[g], i = h.name, j = h.nodeValue;
                        if (i.indexOf("data-") > -1) {
        ...
        _printSort: function (a) {
            var b = this, c = a ? b._startOrder : b._newOrder, d = b._$parent[0].querySelectorAll(b.selectors.target), e = d[d.length - 1].nextElementSibling, f = document.createDocumentFragment();
